...
def generate_launch_description():
  ...
  pkg_share = FindPackageShare(package='navigation_sidewalk').find('navigation_sidewalk')
  default_launch_dir = os.path.join(pkg_share, 'launch')
  default_model_path = os.path.join(pkg_share, 'src/description/basic_mobile_bot.urdf') 
  robot_name_in_urdf = 'basic_mobile_bot'
  default_rviz_config_path = os.path.join(pkg_share, 'rviz/nav2_config.rviz')
  world_file_name = 'sidewalk_world.sdf'
